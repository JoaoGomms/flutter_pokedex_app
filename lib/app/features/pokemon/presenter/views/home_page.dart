      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  return Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? value) {
                        ...
                        controller.sortPokemons(controller.dropdownValue);
                      },
            ...
            Observer(builder: (_) {
              return Container(
                height: controller.pokemons.isEmpty ? MediaQuery.of(context).size.height * 0.8 : null,
                ...
                child: controller.pokemons.isEmpty && controller.isLoadingPokemons
                    ? const PokemonLoadingIcon(
                        color: Palette.primary,
                      )
                    : Column(
                        children: [
